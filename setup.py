...
setup(
    ...
    author="Fesih Keskin",  # The author's name
    author_email="fesihkeskin@gmail.com",  # The author's email
    ...
    url="https://github.com/kullanici/ornek_paket",  # The URL of the project's homepage
